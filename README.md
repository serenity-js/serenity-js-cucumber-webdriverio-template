...
of web applications using [**Serenity/JS**](https://serenity-js.org), [**Cucumber**](https://github.com/cucumber/cucumber-js), and [**WebdriverIO**](https://webdriver.io/),
and comes pre-configured with **TypeScript**, linting, reporting, and example test scenarios.

Use this template to accelerate your test automation setup and generate [Serenity/JS HTML reports](https://serenity-js.org/handbook/reporting/html-reporter/) with trend history and living documentation.
...
- [Serenity/JS HTML Report](https://serenity-js.github.io/serenity-js-cucumber-webdriverio-template/)

## Features

- Pre-configured **Serenity/JS** + **Cucumber** + **WebdriverIO** + **TypeScript** setup
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://github.com/codespaces/new?ref=main&repo=serenity-js/serenity-js-cucumber-webdriverio-template)
...
npm test -- --spec features/authentication/form-based_authentication.feature
...
├── step-definitions/
│   └── the-internet.steps.ts              # Cucumber step definitions
└── support/
...
└── authentication/                        # Example authentication-related tasks
    ...
    └── ui/                                # Page objects and UI elements
...
- Update `baseUrl` in [`wdio.conf.ts`](wdio.conf.ts) to point to your application
...
- [Using Serenity/JS with WebdriverIO](https://serenity-js.org/handbook/test-runners/webdriverio/)
